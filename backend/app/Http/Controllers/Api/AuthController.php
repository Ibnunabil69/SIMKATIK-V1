...
class AuthController extends Controller
{
    public function login(Request $request)
    {
        ...
        if (!$user) {
            return response()->json([
                'message' => 'Email atau password salah memek'
            ], 401);
        }
    ...
    public function verifyEmail(Request $request, $id)
    {
        ...
        if ($user->email_verified_at) {
            return response(ViewVerificationHelper::emailVerificationPage(
                'success',
    ...
    public function forgotPassword(Request $request)
    {
        try {
            ...
            $emailSent = EmailHelper::sendResetPasswordVerificationEmail(
                $user->email,
                $user->username,
                $verificationCode
            );
